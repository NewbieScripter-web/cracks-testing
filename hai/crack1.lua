...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/NewbieScripter-web/cracks-testing/refs/heads/main/Library.lua"))()
...
if not t.EAGLE then
    ...
    local fhop = loadstring(game:HttpGet("https://raw.githubusercontent.com/NewbieScripter-web/cracks-testing/refs/heads/main/crack.lua"))()
